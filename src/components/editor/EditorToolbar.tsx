...
export function EditorToolbar({
  ...
  // Reusable action buttons (used in both mobile row-2 and desktop single-row)
  ...
  return (
    ...
    >
      {/* Row 1: Language + Bot selector + Bot name (shown on all screens) */}
      <div className="flex items-center gap-2 flex-nowrap overflow-x-auto scrollbar-none">
        ...
        {/* Desktop-only: action buttons inline in row 1 */}
      ...
      {/* Row 2 (mobile only): action buttons on their own row */}
